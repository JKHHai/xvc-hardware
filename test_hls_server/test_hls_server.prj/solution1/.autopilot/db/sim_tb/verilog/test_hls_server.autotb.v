...
`define AUTOTB_TVIN_input_V  "./c.test_hls_server.autotvin_input_V.dat"
`define AUTOTB_TVIN_output_V  "./c.test_hls_server.autotvin_output_V.dat"
`define AUTOTB_TVIN_input_V_out_wrapc  "./rtl.test_hls_server.autotvin_input_V.dat"
`define AUTOTB_TVIN_output_V_out_wrapc  "./rtl.test_hls_server.autotvin_output_V.dat"
`define AUTOTB_TVOUT_output_V  "./c.test_hls_server.autotvout_output_V.dat"
`define AUTOTB_TVOUT_output_V_out_wrapc  "./impl_rtl.test_hls_server.autotvout_output_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.test_hls_server.autotvout_output_V.dat", "r");
    fp2 = $fopen("./impl_rtl.test_hls_server.autotvout_output_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.test_hls_server.autotvout_output_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.test_hls_server.autotvout_output_V.dat\"!");
    else begin
        $display("Comparing rtl.test_hls_server.autotvout_output_V.dat with impl_rtl.test_hls_server.autotvout_output_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_IN_input_V "./stream_size_in_input_V.dat"
    ...
    `define STREAM_SIZE_OUT_output_V "./stream_size_out_output_V.dat"
