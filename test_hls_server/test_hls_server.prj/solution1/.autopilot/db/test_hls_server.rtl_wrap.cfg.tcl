...
set DataType0 [list "axistream" "struct axistream" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "axistream" "struct axistream" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
