...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.test_hls_server.autotvin_input_V.dat"
         "c.test_hls_server.autotvin_output_V.dat"
         "c.test_hls_server.autotvout_output_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.test_hls_server.autotvout_output_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
