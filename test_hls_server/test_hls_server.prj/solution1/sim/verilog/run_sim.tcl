...
if {[file isfile test_hls_server.autotvin.dat]} {
	file delete -force test_hls_server.autotvin.dat
}

if {[file isfile test_hls_server.autotvout.dat]} {
	file delete -force test_hls_server.autotvout.dat
}
