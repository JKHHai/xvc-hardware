...
HD_PWD='/home/justin/paulchowresearch2020/xvc/xvc-hardware/test_hardware_server/test_hardware_server.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_hardware_server.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_hardware_server.tcl
